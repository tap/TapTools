{
	"patcher" : 	{
		"rect" : [ 135.0, 88.0, 546.0, 307.0 ],
		"bgcolor" : [ 0.1, 0.1, 0.1, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 135.0, 88.0, 546.0, 307.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 70.0, 227.0, 75.0, 17.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"size" : 10,
					"patching_rect" : [ 262.0, 147.0, 106.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 146.0, 225.0, 65.0, 17.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"id" : "obj-3",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "tap.plug.multiparam.txt[1]",
					"text" : "plugmultiparam 1 8 0. 1. name_of_parameter",
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 280.0, 237.0, 214.0, 17.0 ],
					"numoutlets" : 3,
					"fontname" : "Arial",
					"outlettype" : [ "", "", "" ],
					"id" : "obj-4"
...
, 			{
				"box" : 				{
					...
					"text" : "tap.plug.multiparam 1 8 0. 1. name_of_parameter",
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 262.0, 201.0, 234.0, 17.0 ],
					"numoutlets" : 4,
					"fontname" : "Arial",
					"outlettype" : [ "", "", "", "" ],
					"id" : "obj-5"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "use this object sort of like you would use plugmultiparam for a typical multislider or list controlled item",
					"linecount" : 3,
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 12.0, 155.0, 224.0, 38.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"frgb" : [ 0.227451, 0.227451, 0.227451, 1.0 ],
					"id" : "obj-13",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 271.5, 226.0, 252.0, 226.0, 252.0, 138.0, 271.5, 138.0 ]
				}
