{
	"patcher" : 	{
		"rect" : [ 71.0, 53.0, 546.0, 415.0 ],
		"bglocked" : 0,
		"defrect" : [ 71.0, 53.0, 546.0, 415.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 66.0, 142.0, 55.0, 17.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 2,
					"patching_rect" : [ 8.0, 204.0, 67.0, 17.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "signal" ],
					"id" : "obj-3"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 8.0, 156.0, 51.0, 17.0 ],
					"numoutlets" : 2,
					"fontname" : "Arial",
					"outlettype" : [ "float", "bang" ],
					"id" : "obj-4",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 9.0, 142.0, 52.0, 17.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
					"id" : "obj-5"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 2,
					"patching_rect" : [ 8.0, 179.0, 39.0, 17.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "signal" ],
					"id" : "obj-6"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"patching_rect" : [ 55.0, 276.0, 100.0, 50.0 ],
					"numoutlets" : 0,
					"rounded" : 0,
					"id" : "obj-7"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 8.0, 240.0, 78.0, 17.0 ],
					"numoutlets" : 2,
					"fontname" : "Arial",
					"outlettype" : [ "signal", "" ],
					"id" : "obj-8"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 2,
					"patching_rect" : [ 139.0, 237.0, 69.0, 15.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"id" : "obj-9"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 139.0, 220.0, 48.0, 17.0 ],
					"triangle" : 0,
					"transparent" : 1,
					"numoutlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Set the base frequency of the oscillator",
					"linecount" : 2,
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 245.0, 224.0, 138.0, 28.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
					"id" : "obj-11"
...
, 			{
				"box" : 				{
					...
					"orientation" : 2,
					"numinlets" : 2,
					"patching_rect" : [ 9.0, 267.0, 20.0, 61.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 2,
					"patching_rect" : [ 55.0, 341.0, 65.0, 15.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"id" : "obj-16"
...
, 			{
				"box" : 				{
					"maxclass" : "ezdac~",
					"numinlets" : 2,
					"patching_rect" : [ 8.0, 337.0, 33.0, 33.0 ],
					"numoutlets" : 0,
					"id" : "obj-17"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "This is a simple wavetable oscillator. A signal input is applied to the frequency of the oscillator as a modulator.",
					"linecount" : 2,
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 133.0, 161.0, 284.0, 28.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
					"id" : "obj-18"
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 17.0, 332.0, 31.5, 332.0 ]
				}
