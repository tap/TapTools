...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 496.0, 157.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 122.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 694.0, 122.0, 142.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 695.0, 148.0, 80.0, 4.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 7.0, 80.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 589.0, 215.0, 71.0, 19.0 ],
					"text" : "jcom.out~ 1"
				}
...
, 			{
				"box" : 				{
					"annotation" : "The waveform used by the oscillator.  Choices are sine - square - triangle - ramp",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-3",
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 26.0, 65.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 25.0, 65.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 327.0, 81.0, 607.0, 31.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Frequency of the oscillator in cycles per second.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-5",
					"maxclass" : "flonum",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 23.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 25.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.0, 45.0, 60.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.0, 46.0, 60.0, 19.0 ],
					"text" : "depth"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Depth (amplitude) of the oscillator.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-9",
					"maxclass" : "flonum",
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 44.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 46.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 24.0, 60.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 137.0, 27.0, 60.0, 19.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 26.0, 41.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 25.0, 31.0, 19.0 ],
					"text" : "type"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 111.0, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 589.0, 248.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 589.0, 186.0, 49.0, 19.0 ],
					"text" : "tap.lfo~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 225.0, 19.0, 19.0 ]
				}
