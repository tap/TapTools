...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.5, 94.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 320.0, 141.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 275.0, 141.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 345.0, 80.0, 4.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 300.0, 80.0, 4.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 347.0, 58.0, 72.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 47.0, 72.0, 19.0 ],
					"rounded" : 8.0,
					"text" : "Normalize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 133.0, 76.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 106.0, 46.0, 190.0, 20.0 ],
					"range" : [ -1.0, 1.0 ],
					"text" : "panorama"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 270.0, 330.0, 24.0, 19.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 124.0, 141.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 330.0, 84.0, 19.0 ],
					"text" : "jcom.out~ 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 380.0, 210.0, 66.0, 19.0 ],
					"text" : "jcom.in~ 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 124.0, 36.0, 17.0 ],
					"text" : "/init"
				}
...
, 			{
				"box" : 				{
					"annotation" : "length of the buffer in [ms]",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "flonum",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 349.0, 21.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 25.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 25.0, 112.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 108.0, 25.0, 104.0, 19.0 ],
					"text" : "capture time [ms]"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "send a 1 to start recording the loop",
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 393.0, 17.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 24.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 25.0, 49.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 25.0, 49.0, 19.0 ],
					"text" : "capture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.0, 154.0, 231.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 94.0, 20.0, 20.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.tap.grabloop~.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/Tap.Tools/audio/grabloop~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
