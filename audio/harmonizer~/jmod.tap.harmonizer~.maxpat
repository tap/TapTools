...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 93.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 365.0, 141.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 320.0, 141.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 390.0, 80.0, 4.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 345.0, 80.0, 4.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 44.0, 84.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 43.0, 84.0, 19.0 ],
					"text" : "Window (ms)"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Length of internal buffers in milliseconds.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-13",
					"maxclass" : "number",
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 530.0, 247.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.0, 43.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					"annotation" : "The amount of pitch shift in semitones.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-17",
					"maxclass" : "flonum",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 538.0, 106.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.0, 23.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 25.0, 62.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 24.0, 62.0, 19.0 ],
					"text" : "Shift Right"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 537.0, 65.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 23.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 44.0, 84.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 43.0, 84.0, 19.0 ],
					"text" : "Window (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 527.0, 211.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 43.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 25.0, 62.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 24.0, 62.0, 19.0 ],
					"text" : "Shift Left"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 249.5, 290.0, 99.5, 290.0 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.tap.harmonizer~.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/Tap.Tools/audio/harmonizer~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tap.semitone2ratio.maxpat",
