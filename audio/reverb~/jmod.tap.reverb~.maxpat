...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 161.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 370.0, 138.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 108.0, 346.0, 234.0, 19.0 ],
					"text" : "jcom.oscroute /earlyReflections/active /view"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "Toggles on/off early-reflections",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 78.0, 501.0, 79.0, 19.0 ],
					"text" : "jcom.out~ 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 78.0, 323.0, 64.0, 19.0 ],
					"text" : "jcom.in~ 2",
...
, 			{
				"box" : 				{
					"annotation" : "Damping filter cutoff in Hz. Emulates the effect air and walls have on sound as it travels and reflects.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-3",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 430.0, 310.0, 606.0, 43.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Delay time in milliseconds. Relates to room size / how quickly echo density builds up in the reverberator.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-6",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					"annotation" : "Decay time in seconds. How long (in seconds) for the reverberant sound to decay 60 dB.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-8",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 430.0, 160.0, 595.0, 43.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Cutoff frequency for a final lowpass filter stage to control the brightness of the reverb.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-10",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					"annotation" : "Modulation frequency in Hz - applied to the delay times internally.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-12",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 430.0, 60.0, 601.0, 43.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Modulation depth for the delay-time modulator",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-16",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 430.0, 260.0, 577.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 293.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 78.0, 528.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 293.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 78.0, 448.0, 175.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 528.0, 20.0, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 102.5, 399.0, 243.5, 399.0 ],
					"source" : [ "obj-2", 1 ]
				}
