{
	"patcher" : 	{
		"rect" : [ 207.0, 84.0, 546.0, 244.0 ],
		"bgcolor" : [ 0.1, 0.1, 0.1, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 207.0, 84.0, 546.0, 244.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 122.0, 179.0, 65.0, 17.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 40.0, 182.0, 75.0, 17.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "tap.plug.pp.mxb[1]",
					"text" : "pp 1 hidden fixed some_param_name 0. 1. some_units",
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 256.0, 169.0, 252.0, 17.0 ],
					"numoutlets" : 3,
					"fontname" : "Arial",
					"outlettype" : [ "", "float", "" ],
					"id" : "obj-4",
					"save" : [ "#N", "pp", 1, "hidden", "fixed", "some_param_name", 0.0, 1.0, "some_units", ";" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "tap.plug.pp.mxb",
					"text" : "tap.plug.pp.hidden 1 some_param_name 0. 1. some_units",
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 259.0, 141.0, 264.0, 17.0 ],
					"numoutlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "tap.plug.pp is a wrapper around the pp object, using the same basic (but fixed number of) arguments.",
					"linecount" : 3,
					"fontsize" : 7.9,
					"numinlets" : 1,
					"patching_rect" : [ 9.0, 135.0, 204.0, 38.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"frgb" : [ 0.227451, 0.227451, 0.227451, 1.0 ],
					"id" : "obj-13",
