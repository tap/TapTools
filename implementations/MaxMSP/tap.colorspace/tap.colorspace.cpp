...
static t_symbol	*ps_no_transform, *ps_rgb2cmy, *ps_cmy2rgb, *ps_rgb2hsv, *ps_hsv2rgb,
...
static t_symbol	*ps_split, *ps_packed;			
...
void cs_inletinfo(t_cs *x, void *b, long a, char *t);
...
double cbrt(double x)
{
	...
	double z;
	//double frexp(), ldexp();
	int CBT2[] = {0x3ff4,0x28a2,0xf98d,0x728b};
	int CBT4[] = {0x3ff9,0x65fe,0xa53d,0x6e3d};
